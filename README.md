...
I'm __not convinced that using ES6 class syntax in this fashion is the best long term solution for React__, but Dan has established a solid, __reasonable set of guidelines__ to follow in the meantime. __If you feel that you must use ES6 classes to create React componenets, please follow his lead:__
